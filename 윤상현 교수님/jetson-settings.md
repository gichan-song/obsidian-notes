...
sudo apt-get install libprotobuf-dev libgoogle-gwlog-dev libgflags-dev
...
nvgstcapture-1.0 --orientation=2	# cs 카메라
nvgstcapture-1.0 --camsrc=0 --cap-dev-node=1	#usb카메라